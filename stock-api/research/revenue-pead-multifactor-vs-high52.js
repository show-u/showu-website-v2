...
const SEED=20261009,TARGET=50,H=84;
...
(async()=>{
 console.log('PROTOCOL',JSON.stringify({
  ...
  sample:'fresh TWSE/TPEx stocks, all prior research stocks excluded',
 ...
 console.log('RESULT',JSON.stringify({nStocks:Object.keys(data).length,nDates:dates.length,result,versusHIGH52:versus}));
