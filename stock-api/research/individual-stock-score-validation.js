...
(async()=>{
 ...
 console.log('RESULT',JSON.stringify({summary:S,headToHead:{BplusVsMOM20:pair('Bplus','MOM20'),A_vs_MOM20:pair('A','MOM20')},eventBacktestLimitation:'5-point event component is neutral in historical validation; live use requires current-event veto rather than historical score inference.'}));
