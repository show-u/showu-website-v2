...
const SEED=20261017, TARGET=80, H=84;
...
(async()=>{
 console.log('PROTOCOL',JSON.stringify({
  objective:'Independent confirmatory replication of the pre-specified RIGHTTAIL_5 winner score',
  target:'future 84-trading-day return >= +20%',
  sample:'fifth independent fresh universe; every previously used stock excluded',
