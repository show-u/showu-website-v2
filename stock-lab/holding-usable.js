...
(function(){
  ...
  async function run(){
    ...
    try{
      ...
      const [cache,factors,hist]=await Promise.all([compliance.licensedCache(),compliance.factorData?.()||Promise.resolve({}),historyStatus()]);
