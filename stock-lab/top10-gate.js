...
(function(){
  ...
  function blocked(reason){renderCached(`<div class=toprow><div><h2>入場候選 TOP 10</h2><div class=muted>目前無法形成正式排名</div></div></div><h3 class=bad>⛔ 暫不產生 TOP 10</h3><p>${esc(reason)}</p><div class=disclaimer><b>資料規則</b>任何必要資料、合法性、樣本外驗證或信心校準缺漏，都不以舊模型或假資料補排名。</div>`)}
  ...
  btn.onclick=async()=>{
    ...
    try{
      ...
      if(rt.gates?.entryScannerOosValidation!==true||rt.gates?.scannerConfidenceCalibration!==true)return blocked('TOP10 的正式 OOS 或信心校準尚未通過。');
